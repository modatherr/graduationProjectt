    ...
    const html = `
        ...
        <body>
            ...
            <div class="section">
                ...
                <div class="content">
                    ${cleanText(formData.certifications)
                      .split("\n\n")
                      .map((cert) => {
